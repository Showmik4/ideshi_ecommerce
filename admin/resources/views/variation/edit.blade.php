...
@section('title'){{ 'Variation Edit' }}@endsection
@section('header.css')
    <style>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-wizard" action="{{ route('variation.update', $variation->variationId) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="variationType" id="variationType" onchange="changeValueDiv()" required>
                                                ...
                                                <option value="color" @if($variation->variationType === 'color') selected @endif>Color</option>
                                                <option value="size" @if($variation->variationType === 'size') selected @endif>Size</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="selectionType" id="selectionType" required>
                                                ...
                                                <option value="checkbox" @if($variation->selectionType === 'checkbox') selected @endif>Checkbox</option>
                                                <option value="dropdown" @if($variation->selectionType === 'dropdown') selected @endif>Dropdown</option>
                                            </select>
                                        ...
                                        <div class="mb-3" id="colorValueDiv">
                                            ...
                                            <input type="color" class="form-control" name="color" id="color" value="{{ @$variation->variationValue }}">
                                            <span class="text-danger"><b>{{ $errors->first('color') }}</b></span>
                                        </div>
                                        <div class="mb-3" id="sizeValueDiv">
                                            <label for="size">Variation Value</label>
                                            <input type="text" class="form-control" name="size" id="size" placeholder="Size Value" value="{{ @$variation->variationValue }}">
