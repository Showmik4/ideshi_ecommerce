        ...
        $(document).ready(function () {
            $('#customerTable').DataTable({
                ...
                columns: [
                    ...
                    {title: 'Billing Address', data: 'billingAddress', name: 'billingAddress', className: "text-center", orderable: true, searchable: true}, 
                    {title: 'Shipping Address', data: 'shippingAddress', name: 'shippingAddress', className: "text-center", orderable: true, searchable: true},                 
                    ...
                    {title: 'Action', className: "text-center", data: function (data) {
                            return '<a title="edit" class="btn btn-warning btn-sm" data-panel-id="' + data.customerId + '" onclick="editCustomer(this)"><i class="fa fa-edit"></i></a>';
                                // + ' <a title="delete" class="btn btn-danger btn-sm" data-panel-id="' + data.customerId + '" onclick="deleteCustomer(this)"><i class="fa fa-trash"></i></a>';
