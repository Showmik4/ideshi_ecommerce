                ...
                <div class="col-sm-7">
                    <div class="row align-items-center my-1">
                        ...
                        <div class="col-md-4 text-right">
                            <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#customerSearch" style="padding: .65rem 1.5rem;">
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <tbody id="existItems">
                                        ...
                                        <tr id="initial">
                                            ...
                                            <td style="text-align: center">
                                                <button type="button" class="btn btn-danger " onclick="showQuantityform({{$item}})"><i class="fa fa-edit"></i><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display: none"></span></button>
                                            </td>
                                        </tr>   
                                        @endforeach
                                    </tbody>
                            ...
                            <button onclick="clearCart()" type="button"  class="btn btn-danger m-1"><i id="delIcon" class="fa fa-trash-2"></i><span id="delSpinner" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display: none"></span>Reset cart</button>
                            <div style="text-align: right;">
                             ...
                             <form id="orderForm"> 
                                @csrf
                                <input type="hidden" class="form-control" id="customerId" placeholder="Search here" aria-label="" name="customerId" value=" {{$order->fkCustomerId}} ">
...
$(function () {
    ...
    */
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="billingAddress"
                                                    class="form-control" placeholder="Info here"
                                                    name="billingAddress" value="${address.billingAddress}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="shippingAddress"
                                                    class="form-control" placeholder="Info here"
                                                    name="shippingAddress" value="${address.shippingAddress || ""}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    function showQuantityform(data){
        // alert('sd');
        console.log('sdsd',data);
        if (data.sku.product.type == 'single') {
                   singleProduct(data.sku.skuId, data.sku.product.productName)
                }else{
                    variationSelect(data.sku.product)
                } 
        // $('#quantityExist').hide()
        // $('#quantityEdit').show()
    }
